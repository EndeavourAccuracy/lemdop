...
The lemdop website can be found at [ https://github.com/EndeavourAccuracy/lemdop ].
...
Instructional video (17 December 2016):
https://www.youtube.com/watch?v=boCpi6um1nk

Also, my apoplexy level editor uses a similar GUI.
...
If lemdop crashes, gets compilation errors or crashes while building, send an e-mail to [ nlmdejonge@gmail.com ]. Make sure to describe exactly what actions triggered the bug and the precise symptoms of the bug. If possible, also include: 'uname -a', 'gcc -v', 'sdl2-config --version', and 'lemdop --version'.
...
Copy the Dev-Cpp/MinGW64/i686-w64-mingw32/bin/*.dll files to the lemdop directory.
...
C Project
Name: lemdop
Save lemdop.dev to the lemdop directory.
